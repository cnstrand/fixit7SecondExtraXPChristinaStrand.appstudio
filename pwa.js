...
const cacheName = 'fixit7SecondExtraXPChristinaStrand-2020-11-26 22:59:32.219441'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit7SecondExtraXPChristinaStrand'.length) === 'fixit7SecondExtraXPChristinaStrand') {
